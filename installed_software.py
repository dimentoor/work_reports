...
# Отчет Сервера администрирования Kaspersky Security Center 12 (Отчет об установленных программах)
# “Программа” – 744 - количество уникальных полей “Программа” в исходном отчете. По результатам обработки получилось сократить это число до 355.
#
# Способ сокращения количества программ – вычисление "отношения схожести" между двумя строками. Сравниваются две строки и возвращается числовое значение от 0 до 100, где 100 означает полное совпадение. Это значение представляет собой степень схожести между двумя строками, выраженную в процентах.
# Однако результат, представленный в прикрепленных отчетах может потребовать ручной проверки и дообработки.
